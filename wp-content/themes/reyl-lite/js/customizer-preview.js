...
( function( $ ) {
	...
	// Logo
	wp.customize( 'reyl_lite_logo', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				var logo = '<img src="' + to + '" />';
    ...
    */
		//Featured Color
		wp.customize( 'reyl_lite_hero_color', function( value ) {
			value.bind( function( to ) {
		...
		//Text Color
		wp.customize( 'reyl_lite_text_color', function( value ) {
			value.bind( function( to ) {
				$( 'body' ).css( {
						'color': to
				} );
		...
		//Link Color
		wp.customize( 'reyl_lite_link_color', function( value ) {
			value.bind( function( to ) {
				$( 'a' ).css( {
						'color': to
				} );
