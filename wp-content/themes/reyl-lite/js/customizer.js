jQuery(window).load(function (){
	( function( $ ) {
		...
		//Scroll to section
		$('body').on('click', '#accordion-panel-reyl_lite_front_page_sections .control-subsection .accordion-section-title', function(event) {
		...
		function scrollToSection( section_id ){
			...
			switch ( section_id ) {
				...
				case 'accordion-section-services':
			        ...
			        break;
			    case 'accordion-section-reyl_lite_quote_section':
			        section_class = "quote-section";
			        break;
			    case 'accordion-section-reyl_lite_video_section':
			        section_class = "video-section";
			        break;
			    case 'accordion-section-reyl_lite_testimonials_section':
			        section_class = "testimonials-section";
			        break;
			    case 'accordion-section-reyl_lite_image_section':
			        section_class = "image-section";
			        break;
			    case 'accordion-section-reyl_lite_team_section':
			        section_class = "team-section";
			        break;
			    case 'accordion-section-reyl_lite_phone_section':
			        section_class = "phone-section";
			        break;
			    case 'accordion-section-reyl_lite_tagline_section':
			        section_class = "tagline-section";
			        break;
			    case 'accordion-section-reyl_lite_clients_section':
			        section_class = "clients-section";
			        break;
			    case 'accordion-section-reyl_lite_map_section':
			        section_class = "map-section";
			        break;
			    case 'accordion-section-reyl_lite_pricing_section':
			        section_class = "pricing-section";
			        break;
			    case 'accordion-section-reyl_lite_portfolio_section':
			        section_class = "portfolio-section";
			        break;
			    case 'accordion-section-reyl_lite_blog_section':
		...
		//console.log("a");
		//console.log( wp.customize.control( 'reyl_lite_quote' ).section() );
